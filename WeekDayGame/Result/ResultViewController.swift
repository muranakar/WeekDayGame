...
class ResultViewController: UIViewController {
    ...
    required init?(coder: NSCoder,weekDayGame: WeekDayGame) {
        self.weekDayGame = weekDayGame
        let multiplicationNumByQuizLevel: Int
        switch weekDayGame.quizLevel {
        case .hard:
        ...
        getCoinByQuizLevel = weekDayGame.correctCount * multiplicationNumByQuizLevel
